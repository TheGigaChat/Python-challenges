...
65
"""
days = int(input("Enter the value for days:"))  # 24 hours * 60 = 1440
hours = int(input("Enter the value for hours:"))  # 60 minutes
minutes = int(input("Enter the value for minutes:"))  # 1 minute
seconds = int(input("Enter the value for seconds:"))  # 1/60 minutes

output = days * 1440 + hours * 60 + minutes + seconds / 60
print(output)
